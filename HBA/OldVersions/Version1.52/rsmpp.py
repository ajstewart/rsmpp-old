...
#---Version 1.52---
#Made checking of sub bands quieter
#Changed destroy mode to 'lightweight' mode

#---Version 1.51---
#Minor bug fixes - userthresh,nchan in resume mode, resume append
#Added nchan to log

#---Version 1.5---
#Addded imaging to threshold or not switch.
#Added peeling on off switch.
#Added peeling flux limit
#Re-enabled final concat step
#Email on crash with error
#Resume on crash
#Added phase only mode

#---Version 1.41---
#Addded nice level option.
#Added imaging on off switch.

#---Version 1.4---
#Arguments now passed through a parset.
...
if curr_env["LOFARROOT"] != rsmf.correct_lofarroot:
	print "\nCorrect Environment, as of 23/07/2013, has not been loaded!\n\
...
Script now exiting...".format(i, data_dir))
		...
		resumefile.write("completed_steps={0}\nnchans={1}".format(completed_steps, nnchans))
		resumefile.close()
		if mail==True:
			if user=="mp":
