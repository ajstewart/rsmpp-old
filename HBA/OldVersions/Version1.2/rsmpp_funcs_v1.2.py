...
import os, subprocess,time, multiprocessing, glob, datetime, pyfits, sys
import numpy as np
...
def convert_newawimager(environ):
	...
	"""
	environ['LOFARROOT']="/opt/share/lofar-archive/2013-01-31-16-11/LOFAR_r_b0fc3f4"
	environ['PATH']="/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/opt/share/soft/pathdirs/bin:/opt/share/lofar-archive/2013-01-31-16-11/pathdirs/bin"
	environ['LD_LIBRARY_PATH']="/opt/share/soft/pathdirs/lib:/opt/share/lofar-archive/2013-01-31-16-11/pathdirs/lib"
	environ['PYTHONPATH']="/opt/share/soft/pathdirs/python-packages:/opt/share/lofar-archive/2013-01-31-16-11/pathdirs/python-packages"
	return environ
...
correct_lofarroot='/opt/share/lofar-archive/2013-02-07-13-37/LOFAR_r23543_10c8b37'