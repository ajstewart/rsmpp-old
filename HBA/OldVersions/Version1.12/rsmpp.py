...
#Written by Adam Stewart, Last Update January 2013
...
if image==True:
	...
	if image_meth=="AW" or image_meth=="BOTH":
		...
		mask_size=""
		for sets in aw_sets:
			if "npix=" in sets or "cellsize=" in sets or "data=" in sets:
				mask_size+=" "+sets.strip('\n')
		print "Creating temp skymodel ready for mask creation..."
		AW_Steps_multi=partial(rsmf.AW_Steps, aw_sets=aw_sets, mask_size=mask_size, aw_env=awimager_environ, quiet=qu)
		if __name__ == '__main__':
