	...
	for t in targets[i][beamselect]:
		...
		try:
			...
			if calibbeam < beam:
				...
				SB_cal=int(t.split('SB')[1][:3])+(diff*(beam-calibbeam))
			temp.append(SB)
			...
			if miss==False:
				if calibbeam < beam:
					...
					target_bandno=int((SB_cal-(diff*(calibbeam-beam)))/subsinbands)
...
correct_lofarroot={'/opt/share/lofar-archive/2013-06-20-19-15/LOFAR_r23543_10c8b37':'rsm-mainline', '/opt/share/lofar/2013-09-30-16-27/LOFAR_r26772_1374418':'lofar-sept2013', '/opt/share/lofar/2013-12-10-15-45/LOFAR_r27715_c19aee7':'lofar-dec2013'}