...
#Written by Adam Stewart, Last Update March 2013
...
group.add_option("-r", "--skyradius", action="store", type="float", dest="skyradius", default=10, help="Radius of automatically generated field model [default: %default]")
...
group.add_option("-C", "--calibratorbeam", action="store", type="int", dest="calibratorbeam", default=6,help="Specify which beam is the calibrator sub bands [default: %default]")
...
textlog=logging.FileHandler('rsmpplba.log', mode='w')
...
for c in target_obs:
	...
	subprocess.call("mv {0}/*median.pdf {0}/*std.pdf {0}/*.stats {0}/*.tab {0}/flagging".format(c), shell=True)
...
subprocess.call(["cp", "rsmpplba.log", "{0}/rsmpplba_{0}.log".format(newdirname)])